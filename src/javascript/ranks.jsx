...
export default function Ranks() {
  return (
    <div>
      ...
      <center>Obtainable by: Being a staff or developer at Blood Alchemy.</center>

      <center><span class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-gray-600 bg-gray-200">🧪 Trusted BETA Tester</span></center>
